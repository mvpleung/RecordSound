...
public class SoundFiles {
    ...
    public interface ProgressListener {
        /**
         * Will be called by the SoundFiles class periodically
    ...
    // Create and return a SoundFiles object using the file fileName.
    public static SoundFiles create(String fileName,
        ...
        SoundFiles soundFile = new SoundFiles();
        soundFile.setProgressListener(progressListener);
        soundFile.ReadFile(f);
        return soundFile;
    }

    // Create and return a SoundFiles object by recording a mono audio stream.
    public static SoundFiles record(ProgressListener progressListener) {
...
//        return 1024/2;  // just a fixed value here...
    ...
    // A SoundFiles object should only be created using the static methods create() and record().
    private SoundFiles() {
    }
                ...
                if (firstSampleData
                    ...
                    if (mProgressListener != null) {
                        if (!mProgressListener.reportProgress((float) (tot_size_read) / mFileSize)) {
                            ...
                            // SoundFiles object is invalid and should NOT be used afterward!
                            extractor.release();
                            extractor = null;
                            codec.stop();
                            codec.release();
