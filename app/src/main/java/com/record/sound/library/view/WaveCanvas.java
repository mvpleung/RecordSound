...
import com.record.sound.library.inter.CurrentPosInterface;
...
public class WaveCanvas {
    ...
    public void init() {
        ...
        center = new Paint();
        center.setColor(Color.parseColor("#FF6742"));// 画笔为color
        center.setStrokeWidth(10);// 设置画笔粗细
        ...
        mPaint = new Paint();
        mPaint.setColor(Color.parseColor("#FF6742"));// 画笔为color
    ...
    class RecordTask extends AsyncTask<Object, Object, Object> {
        ...
        void SimpleDraw(ArrayList<Short> buf, int baseLine) {
            ...
            Map<Integer, Float> newMarkMap = new HashMap<>();
